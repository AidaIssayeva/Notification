...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent resultIntent = new Intent(getApplicationContext(), Second.class);

		//Option 2: using TaskStackBuilder

	//	TaskStackBuilder stackBuilder= TaskStackBuilder.create(this);
	//	stackBuilder.addParentStack(Second.class);
	//	stackBuilder.addNextIntent(resultIntent);

	//	PendingIntent pendingIntentToOpenApp=stackBuilder.getPendingIntent(0,PendingIntent.FLAG_ONE_SHOT |PendingIntent.FLAG_UPDATE_CURRENT );
